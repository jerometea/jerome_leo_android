...
/*
        ...
        BiersAdapter ba = new BiersAdapter(dataBiers);
        rv.setAdapter(ba);
*/

        Button layout2 = (Button) findViewById(R.id.button4);
        layout2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, book_list.class);
                startActivity(i);
            }
        });
...
/*
    class BiersAdapter extends RecyclerView.Adapter<BiersAdapter.BierHolder> {
        ...
        public BierHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            BierHolder bHolder = new BierHolder(v);
            return bHolder;
        }
    ...
    class BierUpdate extends BroadcastReceiver {
        ...
        public void onReceive (Context context, Intent intent) {
            Log.d("download finish",getIntent().getAction()); // prévoir une action de notification ici
